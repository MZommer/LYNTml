...
class Layer(ET.Element):
    ...
    def __init__(self, name: str, type: str, position: int) -> None:
        ...
        self.type = type
        self.position = position
        # Immutable, not adding protectors
...
class MoveInstance(Instance):
    ...
    def __init__(self, position: int, model: str, date: float, duration: float, GoldMove: bool,
                 OffsetInSubdivisions: int) -> None:
...
class MoveLayer(Layer):
    def AddInstance(self, position: int, model: str, date: float, duration: float, GoldMove: bool,
                    OffsetInSubdivisions: int) -> Instance:
...
class EventLayer(Layer):
    def AddInstance(self, position: int, model: str, offset: float, length: float, color: str) -> EventInstance:
